    ...
    elseif($file_used=="data_table"){
        ...
        <div class="pw-cols col-xs-12 col-md-6">
            <div class="int-awr-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-money"></i>Top Products</h3>
                ...
                <div class="int-awr-box-content">
                    <img src="'. __PW_REPORT_WCREPORT_URL__.'/assets/images/4.jpg" class="charts" >
                </div>
            </div>
        </div>
        <div class="pw-cols col-xs-12 col-md-3">
            <div class="int-awr-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-map-marker"></i>Best Fisrt Purchases</h3>
                    <div class="awr-title-icons">
                        <div class="awr-title-icon awr-add-fav-icon" data-smenu="all_orders"><i class="fa  fa-info "></i></div>
                        <div class="awr-title-icon awr-toggle-icon"><i class="fa fa-arrow-up"></i></div>
                        <div class="awr-title-icon awr-setting-icon" style="display: none;"><i class="fa fa-cog"></i></div>
                ...
                <div class="int-awr-box-content">
                    ...
                    <div class="pw-box-padder">   
                        <div class="pw-info-cnt">
                            <div class="pw-info">
                                <div class="pw-sm-font">Putler Monthly</div>
                                <div class="pw-val pwl-lbl">$3,699.26 • 74</div>
                            </div>
                            <div class="pw-info">
                                <div class="pw-sm-font">Putler Yearly</div>
                                <div class="pw-val pwl-lbl">$2,004.96 • 9</div>
                            </div>
                            <div class="pw-info">
                                <div class="pw-sm-font">Web Entrepreneurs\' Club Premium</div>
                                <div class="pw-val pwl-lbl">$1,062.00 • 6</div>
                            </div>  
                         </div> 
                    </div>
        ...
        <div class="pw-cols col-xs-12 col-md-3">
            <div class="int-awr-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-map-marker"></i>Highest Refunded</h3>
                    <div class="awr-title-icons">
                        <div class="awr-title-icon awr-add-fav-icon" data-smenu="all_orders"><i class="fa  fa-info "></i></div>
                        <div class="awr-title-icon awr-toggle-icon"><i class="fa fa-arrow-up"></i></div>
                        <div class="awr-title-icon awr-setting-icon" style="display: none;"><i class="fa fa-cog"></i></div>
                    ...
                    <div class="pw-box-padder">                    
                        <div class="pw-info-cnt">
                            ...
                            <div class="pw-cols col-xs-4 col-md-4">
                                <span class="pw-md-font">75.00%</span>
                            </div>
                            
                            <div class="pw-cols col-xs-8 col-md-8">
                                <div class="pw-sm-font">Putler Scale</div>
                                <div class="pw-sm-font pw-val">$6.00 • 2</div>
                            </div>
                         </div>
                            <div class="pw-info">
                                <div class="pw-cols col-xs-4 col-md-4">
                                    <span class="pw-md-font">42.20%</span>
                                </div>
                                
                                <div class="pw-cols col-xs-8 col-md-8">
                                    <div class="pw-sm-font">Album Ninja</div>
                                    <div class="pw-sm-font pw-val">$8.00 • 1</div>
                                </div>
                             </div>
                            <div class="pw-info">
                                <div class="pw-cols col-xs-4 col-md-4">
                                    <span class="pw-md-font">25.00%</span>
                                </div>
                                
                                <div class="pw-cols col-xs-8 col-md-8">
                                    <div class="pw-sm-font">Woo Single</div>
                                    <div class="pw-sm-font pw-val">$6.00 • 2</div>
                                </div>
                             </div>
                        </div>    
        ...
        <div class="col-xs-12 col-md-12">
            <div class="int-awr-box pw-center-align pw-pr-sum-box">
                <div class="col-xs-12 col-sm-6 col-md-3 pw-border-bottom">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">$5,241.59 • 77.54%</div>
                        <div class="pw-val pwl-lbl">TOP 20% PRODUCTS</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3 pw-border-bottom">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">178</div>
                        <div class="pw-val pwl-lbl">QTY SOLD</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3 pw-border-bottom">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">Putler Scale</div>
                        <div class="pw-val pwl-lbl">FASTEST MOVING PRODUCT</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3 pw-border-bottom">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">Icegram</div>
                        <div class="pw-val pwl-lbl">SLOWEST MOVING PRODUCT</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">0.49 / day</div>
                        <div class="pw-val pwl-lbl">AVERAGE QTY SOLD</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">8 / 75</div>
                        <div class="pw-val pwl-lbl">PRODUCTS SOLD VS TOTAL</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">Putler Monthly</div>
                        <div class="pw-val pwl-lbl">TRENDING UP</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">Putler Starter</div>
                        <div class="pw-val pwl-lbl">FALLING DOWN</div>
                    </div>    
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-12">
            <h3 class="pw-out-title">Product Cards</h3>
            
            <div class="pw-cols col-xs-12 col-md-3">
                <div class="pw-cards-cnt" href="#">
                    <div class="pw-cards-thumb">
                        <img src="'. __PW_REPORT_WCREPORT_URL__.'/assets/images/pr-1.jpg" >
                        <div class="pw-rank-cnt" title="Up by 1 positions">
                            <span class="pw-xs-font"> 
                                <span>1</span>
                                <sup>st</sup>
                            </span>
                            <i class="fa fa-arrow-up pw-black"></i>
                        </div>
                    </div>
                    <div class="pw-card-detail pw-center-align">
                        <div class="pw-box-padder">
                            <div class="pw-md-font">Woo Ninja</div>
                            <div class="pw-val pw-sm-font" title="Product ID: sku-woo">sku-woo</div>
                        </div>    
                    </div>
                    <div class="pw-card-bottom">
                        <div class="pw-box-padder">
                            ...
                            <span class="pw-sm-font pull-right pw-card-user" title="Customer">
                                <span class="pw-val"><i class="fa fa-user"></i></span>
                                <span>8</span>
                            </span>
                            <span class="pw-sm-font pull-right" title="Quantities Sold">
            ...
            <div class="pw-cols col-xs-12 col-md-3">
                <div class="pw-cards-cnt">
                    <div class="pw-cards-thumb">
                        <img src="'. __PW_REPORT_WCREPORT_URL__.'/assets/images/pr-4.jpg" >
                    </div>
                    <div class="pw-card-detail pw-center-align">
                        <div class="pw-box-padder">
                            <div class="pw-md-font">Woo Ninja</div>
                ...
                <div class="pw-cards-cnt">
                    ...
                    <div class="pw-card-bottom">
                        <div class="pw-box-padder">
                            ...
                            <span class="pw-sm-font pull-right" >
                                <span class="pw-val"><i class="fa fa-shopping-bag"></i></span>
                                <span>18</span>
                            </span>
