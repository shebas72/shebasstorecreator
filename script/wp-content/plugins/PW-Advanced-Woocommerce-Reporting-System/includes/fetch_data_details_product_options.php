...
//		}
		...
		/// COST OF GOOD
		if($pw_show_cog == "yes"){
		    $pw_show_cog_join=" LEFT JOIN wp_woocommerce_order_itemmeta as woo_itemmeta_cog ON woocommerce_order_itemmeta.order_item_id	=	woo_itemmeta_cog.order_item_id  ";
        }
...
//		}
		...
		if($pw_detail_view=="yes"){
			...
			if(defined("__PW_PO_ADD_ON__") && defined("TM_EPO_VERSION") && $po_fields && is_array($po_fields)) {
