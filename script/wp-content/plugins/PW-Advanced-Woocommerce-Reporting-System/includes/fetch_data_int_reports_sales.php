    ...
    elseif($file_used=="data_table"){
        ...
        <div class="col-xs-12 col-md-6">
            <div class="int-awr-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-money"></i>Sales</h3>
                ...
                <div class="int-awr-box-content">
                    <div class="pw-box-padder">                    
                        <div class="pw-pull-left pw-val pw-lg-font">$8,031.74</div>
                        <div class="pw-pull-right">
                                <span class="pw-val pw-sm-font">down by</span>
                                <span class="pw-red pw-lg-font">52.18%</span>        
                        </div>
                    </div>    
                    <img src="'. __PW_REPORT_WCREPORT_URL__.'/assets/images/1.jpg" class="charts" >
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-md-6">
            <div class="int-awr-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-map-marker"></i>Sales heatmap</h3>
                    <div class="awr-title-icons">
                        <div class="awr-title-icon awr-add-fav-icon" data-smenu="all_orders"><i class="fa  fa-info "></i></div>
                        <div class="awr-title-icon awr-toggle-icon"><i class="fa fa-arrow-up"></i></div>
                        <div class="awr-title-icon awr-setting-icon" style="display: none;"><i class="fa fa-cog"></i></div>
        ...
        <div class="col-xs-12 col-md-12">
            <div class="int-awr-box pw-center-align pw-pr-sum-box">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">$8,031.74 • 96</div>
                        <div class="pw-val pwl-lbl">NET SALES</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">$251.75 • 4 • 3.04%</div>
                        <div class="pw-val pwl-lbl">REFUNDS</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">$86.29</div>
                        <div class="pw-val pwl-lbl">AVERAGE REVENUE / SALE</div>
                    </div>    
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">$259.09</div>
                        <div class="pw-val pwl-lbl">AVERAGE REVENUE / DAY</div>
                    </div>    
                </div>
            </div>
        </div>
            ...
            <div class="int-awr-box pw-pr-customer-list">
                <div class="pw-box-padder">
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper no-footer">
                        <table class="display datatable order_summary_datatable dataTable no-footer" cellspacing="0" width="100%" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info" style="width: 100%;">
                                <thead>
                                    <tr role="row"><th style="width: 221px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>Sales Order</div></th><th style="width: 234px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>Order Count</div></th><th style="width: 162px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>Amount</div></th></tr>
                                </thead>
                                
                                                            
                                <tbody>
                                                                <tr role="row" class="odd"><td style="">Today</td><td style="">0</td><td style=""><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span>0.00</span></td></tr><tr role="row" class="even"><td style="">Yesterday</td><td style="">0</td><td style=""><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span>0.00</span></td></tr><tr role="row" class="odd"><td style="">Week</td><td style="">0</td><td style=""><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span>0.00</span></td></tr><tr role="row" class="even"><td style="">Month</td><td style="">0</td><td style=""><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span>0.00</span></td></tr><tr role="row" class="odd"><td style="">Year</td><td style="">11</td><td style=""><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span>499.29</span></td></tr></tbody>
                ...
                <div class="pw-cus-detail-header">
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div class="pw-pull-left">
                            ...
                            <span class="pw-black pw-lg-font ">Pack Oliver</span>
                        </div>
                            <div class="pw-cus-detail-email pw-sm-font">
                            <i class="fa fa-envelope pw-val"></i>
                            <a class="pw-val" href="mailto:Paule@gmail.com">alice.osullivan@proword.com</a>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-3">
                        ...
                        <div class="pw-xs-font pw-backed-lbl pw-green-back pull-right order-lbl">COMPLETED</div>
                        <div class="clear-fx"></div>
                        <select class="pull-right  pw-xs-font order-select">
                    ...
                    <div class="pw-box-padder"> 
                        <div class="col-xs-12 col-md-8">
                            <table class="pw-simple-dashed-tbl pw-sm-font">
                                    ...
                                    <tr>
                                        <td class="pw-left-align pw-black">
                                            1 x Putler\'s Guide to Sales Analysis - eBook
                                        </td>
                                        <td class="pw-right-align pw-black">
                                            €69.00
                                        </td>
                            ...
                            <div class="pw-note-cnt">
                                ...
                                <textarea cols="3" class="pw-sm-font" placeholder="click here to add note for this order..."></textarea>
                                <button class="pw-button pw-pull-right">Save</button>
                                <div class="clear-fx"></div>
                            </div>
                            <div class="pw-prelated-cnt">
                                <div class="pw-val pwl-lbl">RELATED TRANSACTIONS</div>
                                    <div class="pw-prelated-content-cnt">
                                        <div class="pw-related-item pw-sm-font">
                                            <span class="pw-related-date">08/09/2017</span>
                        ...
                        <div class="col-xs-12 col-md-4 pw-info-cnt">
                            <div class="pw-info">
                                <div class="pw-val pwl-lbl">ACCOUNT</div>
                                <div class="pw-black pw-sm-font">SampleData</div>
                            </div>
                            
                            <div class="pw-info">
                                <div class="pw-val pwl-lbl">TRANSACTION ID</div>
                                <div class="pw-black pw-sm-font">SAMPLE95R133315J97282</div>
                            </div>
                            
                            <div class="pw-info">
                                <div class="pw-val pwl-lbl">SUBSCRIPTION ID</div>
                                <div class="pw-black pw-sm-font">384th payment • €3,811,759.34</div>
                            </div>
                            
                            <div class="pw-info">
                                <div class="pw-val pwl-lbl">DATE AND TIME</div>
                                <div class="pw-black pw-sm-font">2017-09-15 17:49:51</div>
                            </div>
                            
                            <div class="pw-info">
                                <div class="pw-val pwl-lbl">TYPE</div>
                                <div class="pw-black pw-sm-font">Shopping Cart Payment Received</div>
                            </div>
                            
                            <div class="pw-info">
                                <div class="pw-val pwl-lbl">ADDRESS</div>
                                <div class="pw-black pw-sm-font">3513 rue du château, nancy, corrèze, 68997, France</div>
                            </div>
