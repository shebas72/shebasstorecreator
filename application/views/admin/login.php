...
<head>
    ...
    <title><?php echo $this->lang->line('storecreator_login');?></title>
    <!-- Bootstrap Core CSS -->
    ...
    <section id="wrapper">
        ...
        <div class="login-register" style="background-image:url(<?php echo base_url() ?>assets/admin//images/background/login-register.jpg);">        
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="login-form" action="<?php echo base_url('admin/login/log'); ?>" method="post">
                    <h2 class="box-title m-b-40 text-center"><?php echo $this->lang->line('sign_in_storecreator');?></h2>
                    ...
                    <div class="form-group text-center m-t-50">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-block text-uppercase waves-effect waves-light" type="submit"><?php echo $this->lang->line('log_in');?></button>
                        </div>
                    </div>
                ...
                <form class="form-horizontal" id="recoverform" action="#">
                    <div class="form-group ">
                        <div class="col-xs-12">
                            ...
                            <p class="text-muted"><?php echo $this->lang->line('enter_your_email_and_instructions_will_be_sent_to_you');?>! </p>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg btn-block text-uppercase waves-effect waves-light" type="submit"><?php echo $this->lang->line('reset');?></button>
                        </div>
                    </div>
                </form>
            </div>
