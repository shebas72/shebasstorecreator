                ...
                <section id="section-showcase">
                    ...
                    <div class="container">
                        <div class="row">
                          ...
                          <?php } ?>
                            <div class="col-md-12">
                                <h2>Upgrade to full Domain</h2>
                                <p class="displayonfulldomain" style="text-align: center;    font-weight: bold;">You have to change your domain nameserver to <br>
                                ...
                                <div class="content-profile-form">
                                        <div class="form-row" id="domainvalidateform">
                                            <div class="form-group  col-md-6">
                                                ...
                                                <input id="input-domain-t" type="text" name="domain-title" class="form-control" placeholder="Your Domain Title" required title="This is Your Domain Title" value="<?php echo $singledomaininfo->domaintitle;?>" required>
                                            </div>

                                            <div class="form-group  col-md-6">
                                                <label for="input-domain-t"><?php echo $this->lang->line('domain_name');?>:</label>
                                                <input id="input-domain-t-name" type="text" name="domain-link" class="form-control" placeholder="Full Domain Name" required title="This is Full Domain Link" value="<?php echo $singledomaininfo->domainlink;?>" required>
                                            ...
                                            <div class="form-group  col-md-6">
                                                ...
                                                <select name="category" class="form-control selectcategory">
                                                  ...
                                                  <?php foreach ($domaincategory as $domaincategory_value) { ?>
                                                    <option value="<?php echo $domaincategory_value['domaincatid'];?>" <?php if($singledomaininfo->categoryid == $domaincategory_value['domaincatid']) { echo "selected"; }?>><?php if ($siteLang == 'arabic') { echo $domaincategory_value['domaincatnamearb']; } else { echo $domaincategory_value['domaincatname']; }?></option>
                                                  <?php } ?>
                                                </select>
                                            </div>
                                            <div class="form-group  col-md-6">
                                                <label for="input-domain-t"><?php echo $this->lang->line('option');?>:</label>
                                                <input type="radio" name="subdomain" value="2" class="form-control" id="input-domain-t-opt" checked=""> <label for="input-domain-t-opt" style="text-align: center;">Full Domain</label>
                                            </div>
                                            <div class="form-group  col-md-12" style="text-align: center;">
                                            <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />
                                              <input type="hidden" name="domainid" value="<?php echo $singledomaininfo->domainid;?>">
