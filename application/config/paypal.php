 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'shebas_api1.theguardianchief.com' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '5LLBL9CFFE72YT7P' : 'PRODUCTION_PASSWORD_GOGES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'ANPqaIIjJFj9K9rndoPcyjmO.Nd-AS1IHB2xOqTx.ddwzPCdiNmBrXUB' : 'PRODUCTION_SIGNATURE_GOGES_HERE';
$config['clientId'] = $config['Sandbox'] ? 'AQxbqOdTuTLCYvyqV6gNwbpxHyYlEN4zHHp2dCIXHZtX1XmsbKl_gNDHPg899f072trpQ_J0F6D-2Wx5' : 'PRODUCTION_SIGNATURE_GOES_HERE';
$config['clientSecretId'] = $config['Sandbox'] ? 'EOspF7T-vSpGfokn3r8VlT1v6_x3qHecYHo_-LxFevmX1xzgmwRjkLQK_nIKWr9EZNp6gAsIl2sIlMSF' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'info-facilitator@ceodeck.com';
